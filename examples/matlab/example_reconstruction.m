...
currentDir = pwd;
parentDir  = fileparts(currentDir);        % go one level up
headerPath = fullfile(parentDir, 'ODT_GPU_Library','include', 'CUDAprocessing.h');
dllPath    = fullfile(parentDir, 'ODT_GPU_Library','bin', 'v-1_0', 'cuda-12_6', 'ODT_GPU.dll');
...
err = calllib('ODT_GPU','HL00_addReference', hologramInt16_ref, Nx, Ny, nproj, ...
